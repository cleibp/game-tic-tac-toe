var MYAPP = MYAPP || {
  ...
  MYAPP.display = {  
    ...
    var message;
    if (isTwoPlayer) {
      message = "Jogador 1 : Você gostaria de X ou O"
    }
    else {
      message = "Você gostaria de ser X ou O?";
    }
    MYAPP.timeOuts.push(
      setTimeout(function() {
    ...
    if (MYAPP.secondPlayer) {
      $('.player-one-turn p').text('Go Jogador 1!');
    }
    else {
    ...
    if (MYAPP.secondPlayer) {
      $('.player-two-turn p').text('Go Jogador 2!');
    }
    else {
    ...
    showWinMessage: function() {
      MYAPP.timeOuts.push(
        setTimeout(function() {
      $('.win-message').fadeIn(500).children('p').text("Jogador " + MYAPP.turn + " venceu!! :D ")
  }, 1500));
  },
    ...
    showScore: function() {
      if (MYAPP.secondPlayer) {
        $('.score-1').children('.name').text('jogador 1'); 
        $('.score-2').children('.name').text('jogador 2'); 
      }
      else {
        $('.score-1').children('.name').text('jogador 1'); 
        $('.score-2').children('.name').text('computador'); 
      }
